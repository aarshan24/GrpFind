...
LOG = 'https://discord.com/api/webhooks/1242294309638897664/0kiwNLgueINMUDtLGfvRaD4lWbUrVTipiN4vFpSmscJoTheQDASWCo-7B-ba4ZMQBMv8/messages/1242436185830326292'  # webhook for activity log replace numbes at the end of link wit hid of some prevous message sent by this webhook (message has to be in the same channel as webhook)
GROUP = 'https://discord.com/api/webhooks/1242294309638897664/0kiwNLgueINMUDtLGfvRaD4lWbUrVTipiN4vFpSmscJoTheQDASWCo-7B-ba4ZMQBMv8'  # webhook where found groups will be sent

SPECS='(16 cores HETZNER)'#server specification (optional)

#Ratelimit bypass best finder
        ...
        while True:
            ...
            if time.time() - start > 120:
               # print(to_check_owner.qsize()
                ...
                print('Current Speed is: ' + str(curr * 60/(time.time() - start)/10**6+0.00001)[:4] +'M/Min||' ,'-----BEST FINDER -----||',  end='\r')
